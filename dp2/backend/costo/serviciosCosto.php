<?php
	...
	*/
	...
	function CO_obtenerPaquetesHijo(&$paquete) {
		if ($paquete != null) {
			...
			WHEN B.PROFUNDIDAD<>0 AND B.ELIMINADO<>1  AND Z.ID_ESTADO=1 AND D.ESTADO<>'ELIMINADO' AND C.ESTADO<>0
  ...
  function CO_consultarCuentasDesglozable($idProyecto) { //COMPLETO
	...
	function CO_consultarReservaContingencia($idProyecto) {
		...
		PROYECTO B ON A.ID_PROYECTO=B.ID_PROYECTO
		WHERE 
		A.ID_PROYECTO= :idProyecto AND A.positivo_negativo=0;";
