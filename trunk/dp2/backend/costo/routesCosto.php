<?php
	...
	$app->post('/CO_verificaPermisosVista/', 'CO_validarPermisosVista'); //servicio19
	...
	$app->get('/CO_obtenerListaPaquetesCostoReal/:parametro', 'CO_getListaPaquetesCostoReal'); //servicio25
