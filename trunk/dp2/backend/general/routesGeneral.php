...
$app->get('/G_listaProyecto/:id', 'G_getListaProyecto'); //lista de los proyectos de un usuario
$app->get('/G_listaProyecto/', 'G_getListaTodosProyecto'); //lista de todos los proyectos
